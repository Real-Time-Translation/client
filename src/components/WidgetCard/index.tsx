...
export const WidgetCard: FC<WidgetCardProps> = ({ title, subtitle, icon, cornerRadiusDirection }) => {
  const classes = useStyles();

  const TitleIcon = icon as SvgIconComponent;

  const cornerDirectionMappedToClass: Record<WidgetCardCornerRadiusDirection, string> = {
  ...
  const computedCornerDirectionClass = cornerRadiusDirection ? cornerDirectionMappedToClass[cornerRadiusDirection] : '';
